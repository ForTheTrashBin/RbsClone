...
func seedCustodian2Exchange(logger *slog.Logger, dbPool *pgxpool.Pool) error {

	inputName := "custodian2exchange.csv"
	...
	logger.Info("Start import of custodian2exchange data...")
...
func main() {
	...
	if err := seedCustodian2Exchange(logger, dbPool); err != nil {

		logger.Error("Error initializing custodian2exchange", "error", err)
	}
}
